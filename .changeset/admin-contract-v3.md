...
The vocabulary was closed at nine, and eight of mark8ly's mounted platform-admin reads structurally could not be declared — an unknown key throws and fails the entire run. That was one documented fact, not a design. It is now eight new ids across seven surfaces:
