...
- c91c66a: Report the error code a 503 actually carried, instead of blaming the signing
  secret every time.
...
- 8eaad93: Fail a declared endpoint that answers 5xx instead of passing it on §4.4.
