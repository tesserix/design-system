  ...
  ({ className, onClick, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn("inline-flex h-7 w-7 items-center justify-center rounded-md", className)}
        onClick={(event) => {
          onClick?.(event)
          toggleSidebar()
        }}
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] group-data-[side=left]:right-0 group-data-[side=right]:left-0 hover:after:bg-sidebar-border sm:flex",
